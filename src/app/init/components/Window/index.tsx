...
const Window: React.FC<IWindow> = ({ toggle }: IWindow) => {
  return (
    <div className='flex flex-col z-10 absolute top-1/2 left-1/2 rounded overflow-hidden -translate-x-1/2 -translate-y-1/2 bg-zinc-300 w-96'>
      ...
      <div className='flex justify-center items-center h-40 w-full'>
        <ul className='flex flex-row items-center justify-around p-4 pr-8 pl-8 w-full'>
          <li className='flex justify-center items-center w-14 h-14 bg-zinc-900 rounded cursor-pointer'>
